...
def get_args():
    ...
    parser.add_argument("--missing_type", type=int, default=3)
    ...
    parser.add_argument("--image_caption-file", type=str, default="img_caption.mat")
    ...
    _time += str('_mt='+str(args.missing_type)+"_"+args.comment)
